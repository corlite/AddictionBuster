...
本地测试 APK：`dist/瘾头破坏器0.2.8-vc28-release-mascot-slots-debugkey.apk`
...
9. 支持角色与语音坑位：咕嘎、Doro、自定义槽位可导入 App 内图标和 4 条场景语音
...
13. 如需角色提示，进入“设置 / 角色与语音”，选择槽位并导入 1 个图标和 4 条场景语音。
...
0.2.8 起，增加角色与语音坑位：咕嘎、Doro、自定义槽位可分别导入 1 个 App 内角色图标和 4 条场景语音。四条语音分别对应“拦截出现 / 挑战通过 / 手机时长到 / 权限异常”，语音不复用；APK 不内置任何第三方角色素材。
